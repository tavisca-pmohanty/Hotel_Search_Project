...
namespace HotelSearchEngine
{
    public class HotelSearch
    {
        ...
        public void PreservingSessionData(HotelSearchRQ searchRequest)
        {
            ...
            File.WriteAllText(("D:\\FinalHOTELBOOKING\\Hotel_Search_Project\\Tavisca.Training2017.HotelSearch\\HotelSearchEngine\\SessionLog\\HotelSearchCriterion_Json.txt"), JsonConvert.SerializeObject(sessionData));
        }
    }
}
